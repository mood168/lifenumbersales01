import { _ as __nuxt_component_0$2 } from "./nuxt-link-ChxAMr8J.js";
import { defineComponent, createElementBlock, ref, provide, createVNode, resolveDynamicComponent, mergeProps, withCtx, renderSlot, useSSRContext, toRef, computed, openBlock, createBlock, createCommentVNode, toDisplayString, unref, createTextVNode } from "vue";
import "hookable";
import { isEqual, diff } from "ohash";
import { _ as _export_sfc, m as mergeConfig, a as appConfig, b as useState } from "../server.mjs";
import { ssrRenderVNode, ssrRenderSlot, ssrRenderComponent, ssrRenderAttrs, ssrRenderClass, ssrInterpolate, ssrRenderList, ssrRenderAttr } from "vue/server-renderer";
import { _ as __nuxt_component_1$1, u as useInjectButtonGroup } from "./useButtonGroup-BtWhVQ2p.js";
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-a865414d>`);
      if (unref(isSignedIn)) {
        _push(`<!--[--><button class="fixed top-5 right-4 z-50 lg:hidden" data-v-a865414d><div class="w-6 h-5 flex flex-col justify-between" data-v-a865414d><span class="w-full h-0.5 bg-gray-800 dark:bg-white" data-v-a865414d></span><span class="w-full h-0.5 bg-gray-800 dark:bg-white" data-v-a865414d></span><span class="w-full h-0.5 bg-gray-800 dark:bg-white" data-v-a865414d></span></div></button><nav class="${ssrRenderClass([
          ...
          "lg:translate-x-0"
          // 桌面版總是顯示
        ])}" data-v-a865414d><div class="p-6 border-b border-gray-700" data-v-a865414d>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              return [
                createTextVNode(" 紫喬問數 ")
              ];
            }
          }),
          _: 1
        }, _parent));
        _push(`</div><div class="mt-6" data-v-a865414d><!--[-->`);
        ...
        _push(`<!--]--></div><div class="absolute bottom-20 left-0 w-full px-6 py-4 border-t border-gray-700" data-v-a865414d>`);
        _push(ssrRenderComponent(_component_client_only, null, {}, _parent));
        _push(`</div><div class="absolute bottom-6 left-6" data-v-a865414d><div class="flex items-center space-x-4" data-v-a865414d>`);
        ...
        _push(`<div class="w-full" data-v-a865414d>`);
        ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
        _push(`</div>`);
      }
      _push(`</div>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-a865414d"]]);
const _imports_0 = "" + __buildAssetsURL("1920x1080.vr_nIxSX.png");
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen relative" }, _attrs))}><div class="fixed inset-0 z-0"><img${ssrRenderAttr("src", _imports_0)} alt="背景" class="w-full h-full object-cover"></div><div class="relative z-10">`);
      _push(ssrRenderComponent(_component_AppNavbar, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
...
//# sourceMappingURL=default-1jNwrx-S.js.map
