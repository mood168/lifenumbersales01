...
import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, getResponseStatus, setResponseHeaders, setHeaders, sendRedirect, proxyRequest, createError, getQuery as getQuery$1, getRequestURL, getRequestProtocol, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, readBody, getResponseStatusText } from 'file://D:/git-repos/lifenumbersales/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://D:/git-repos/lifenumbersales/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://D:/git-repos/lifenumbersales/node_modules/devalue/index.js';
import destr from 'file://D:/git-repos/lifenumbersales/node_modules/destr/dist/index.mjs';
import { withQuery, joinURL, withTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL } from 'file://D:/git-repos/lifenumbersales/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://D:/git-repos/lifenumbersales/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file://D:/git-repos/lifenumbersales/node_modules/@unhead/ssr/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file://D:/git-repos/lifenumbersales/node_modules/unhead/dist/index.mjs';
import { klona } from 'file://D:/git-repos/lifenumbersales/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://D:/git-repos/lifenumbersales/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://D:/git-repos/lifenumbersales/node_modules/scule/dist/index.mjs';
import { createHooks } from 'file://D:/git-repos/lifenumbersales/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://D:/git-repos/lifenumbersales/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://D:/git-repos/lifenumbersales/node_modules/unenv/runtime/fetch/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://D:/git-repos/lifenumbersales/node_modules/consola/dist/index.mjs';
import { getContext } from 'file://D:/git-repos/lifenumbersales/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://D:/git-repos/lifenumbersales/node_modules/errx/dist/index.js';
import { isVNode, version, unref } from 'file://D:/git-repos/lifenumbersales/node_modules/vue/index.mjs';
import { basename } from 'file://D:/git-repos/lifenumbersales/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file://D:/git-repos/lifenumbersales/node_modules/@iconify/utils/lib/index.mjs';
import { hash } from 'file://D:/git-repos/lifenumbersales/node_modules/ohash/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://D:/git-repos/lifenumbersales/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/git-repos/lifenumbersales/node_modules/unstorage/drivers/fs.mjs';
import { collections } from 'file://D:/git-repos/lifenumbersales/.nuxt/nuxt-icon-server-bundle.mjs';
import { makeAuthObjectSerializable, stripPrivateDataFromObject, constants, AuthStatus } from 'file://D:/git-repos/lifenumbersales/node_modules/@clerk/backend/dist/internal.mjs';
import { eventMethodCalled } from 'file://D:/git-repos/lifenumbersales/node_modules/@clerk/shared/dist/telemetry.mjs';
import { createClerkClient } from 'file://D:/git-repos/lifenumbersales/node_modules/@clerk/backend/dist/index.mjs';
import { isTruthy } from 'file://D:/git-repos/lifenumbersales/node_modules/@clerk/shared/dist/underscore.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/git-repos/lifenumbersales/node_modules/radix3/dist/index.mjs';
import { defineHeadPlugin } from 'file://D:/git-repos/lifenumbersales/node_modules/@unhead/shared/dist/index.mjs';
...
const _yff4CJGPlZ = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script$1}<\/script>`);
  });
});

const rootDir = "D:/git-repos/lifenumbersales";

const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"專業的生命靈數諮詢服務，幫助您了解自己的天賦與潛能"}],"link":[],"style":[],"script":[],"noscript":[],"title":"生命靈數諮詢"};
...
const _ziN04uGnHY = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    "clerk": {
      "publishableKey": "pk_test_aW5zcGlyZWQtbGlvbmVzcy02MS5jbGVyay5hY2NvdW50cy5kZXYk",
      "secretKey": "sk_test_Lov0vfJDac9lUUjOWla6A30WjPxUiGRwMOhdoosGLf",
      "signInUrl": "",
...
const serverAssets = [{"baseName":"server","dir":"D:/git-repos/lifenumbersales/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\git-repos\\lifenumbersales","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\git-repos\\lifenumbersales\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\git-repos\\lifenumbersales\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\git-repos\\lifenumbersales\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"D:\\git-repos\\lifenumbersales\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _k3rDq2 = defineCachedEventHandler(async (event) => {
...
const _lazy_s1yUo2 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_s1yUo2, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _k3rDq2, lazy: false, middleware: false, method: undefined },
  { route: '', handler: middleware_default, lazy: false, middleware: true, method: undefined },
  { route: '/**', handler: _lazy_s1yUo2, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://D:/git-repos/lifenumbersales/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://D:/git-repos/lifenumbersales/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
